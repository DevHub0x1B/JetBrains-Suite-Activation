...
{
    param([string]$Message) Write-Log -Message $Message -Level "DEBUG"
}
function Write-WarningLog
{
    param([string]$Message) Write-Log -Message $Message -Level "WARNING"
}
function Write-ErrorLog
{
    param([string]$Message) Write-Log -Message $Message -Level "ERROR"
}
function Write-SuccessLog
{
    param([string]$Message) Write-Log -Message $Message -Level "SUCCESS"
}
...
function New-ActivationKey
{
    ...
    $productDir = if ($CustomConfigPath)
    {
        $CustomConfigPath
    }
    else
    {
        Join-Path $script:RoamingJetBrainsDir $ProductFullName
    }
...
function Read-LicenseInfo
{
    ...
    $script:License.licenseName = if ( [string]::IsNullOrEmpty($licenseName))
    {
        "ckey.run"
    }
    else
